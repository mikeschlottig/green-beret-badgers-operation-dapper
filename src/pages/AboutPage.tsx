      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="py-8 md:py-10 lg:py-12">
          <header className="mb-24 pt-16 md:pt-24">
            <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} className="text-[10px] uppercase tracking-[0.5em] mb-4 opacity-50 font-mono">
            ...
            <div className="max-w-3xl font-mono text-lg leading-relaxed border-l-2 border-terminal-green pl-6 bg-terminal-dim/5 py-4">
            ...
            <div className="space-y-12">
              ...
              <div className="grid gap-6">
                {[
                  ...
                  >
                    <h3 className="font-bold text-xl mb-2 font-mono text-white">[{idx + 1}] {val.title}</h3>
                    <p className="text-sm text-terminal-green/60 uppercase font-mono leading-tight">{val.desc}</p>
                  </motion.div>
                ))}
              </div>
            </div>
